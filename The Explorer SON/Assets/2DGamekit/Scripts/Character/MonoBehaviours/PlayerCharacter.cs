...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public static bool TengoPigmentoRojo = false;
        public static bool TengoPigmentoNegro = false;
        public static bool TengoGafas = false;
        public static bool TengoPalos = false;
        ...
        public static CharacterController2D m_CharacterController2D;
        protected Animator m_Animator;
        protected CapsuleCollider2D m_Capsule;
        protected Transform m_Transform;
        public static Vector2 m_MoveVector;
        ...
        protected readonly int m_HashEscaloPara = Animator.StringToHash("Escalo");
        ...
        void Awake()
        {
            ...
            //WallCheck = this.gameObject.transform.GetChild(10);
        ...
        //Con esta public void activamos el evento con el inventory controller para que ahora si podamos usar los picos.
        public void ConsigoPicos()
        {
            TengoPicos = true;
            Debug.Log("He conseguido los picos");
        }

        public void ConsigoPigmentoNegro()
        {
            TengoPigmentoNegro = true;
            Debug.Log("He conseguido el pigmento negro");
        }

        public void ConsigoPigmentoRojo()
        {
            TengoPigmentoRojo = true;
            Debug.Log("He conseguido el pigmento rojo");
        }

        public void ConsigoResina()
        {
            TengoResina = true;
            Debug.Log("He conseguido la resina");
        }

        public void ConsigoPalos()
        {
            TengoPalos = true;
            Debug.Log("He conseguido los palos");
        }

        public void ConsigoTubo()
        {
            TengoTubo = true;
            Debug.Log("He conseguido el pigmento negro");
        }

        public void ConsigoGafas()
        {
            TengoGafas = true;
            Debug.Log("He conseguido el pigmento negro");
        }
        ...
        { 
            ...
            {
                m_CharacterController2D.Move(Caer);
            }
